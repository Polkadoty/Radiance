...
public final class VeilRenderSystem {
    ...
    public static VeilRenderer renderer() {
        VeilBackend.requireOpenGl("renderer");
        return renderer;
    }
    ...
    public static boolean hasImGui() {
        return VeilBackend.hasOpenGlRenderer() && Veil.IMGUIMC && ImGuiMC.isImguiLoaded();
    }
    ...
    public static void bootstrap() {
        VeilBackend.requireOpenGl("bootstrap");
    ...
    public static void init() {
        VeilBackend.requireOpenGl("init");
    ...
    public static void beginFrame() {
        VeilBackend.requireOpenGl("beginFrame");
//        VeilImGuiImpl.get().beginFrame();
    ...
    public static void endFrame() {
        VeilBackend.requireOpenGl("endFrame");
...
//        VeilImGuiImpl.get().endFrame();
    ...
    public static void close() {
        if (!VeilBackend.hasOpenGlRenderer()) return; // No GPU resources were initialized.
...
//        }
    ...
    public static void renderPost(@Nullable VeilRenderLevelStageEvent.Stage stage) {
        VeilBackend.requireOpenGl("renderPost");
